...
##        print("Rolling Dice code!")
        ...
        if shot.get() > 2:
            ...
            cTurn.set(True)
            turnLabel = tk.Label(self, text="Player 2    ", font="Ravie 20")
...
##        print("Stop & Score code!")
        ...
        if cTurn.get() == 1:
            ...
            turnLabel = tk.Label(self, text="Player 1    ", font="Ravie 20")
            turnLabel.grid(row=0,column=0)
            if cScore.get()==13:
                turnLabel = tk.Label(self, text="Player 2 Wins", font="Ravie 20")
                turnLabel.grid(row=0,column=0)
            ...
            if uScore.get()==13:
                turnLabel = tk.Label(self, text="Player 1 Wins", font="Ravie 20")
                turnLabel.grid(row=0,column=0)
